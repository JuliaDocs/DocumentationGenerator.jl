...
{
    "location": "#MIDI.BPM-Tuple{MIDIFile}",
    "page": "Home",
    "title": "MIDI.BPM",
    "category": "method",
...
{
    "location": "#MIDI.addevent!-Tuple{MIDITrack,Integer,TrackEvent}",
    "page": "Home",
    "title": "MIDI.addevent!",
    "category": "method",
...
{
    "location": "#MIDI.addevents!-Tuple{MIDITrack,AbstractArray{Int64,N} where N,Any}",
    "page": "Home",
...
{
    "location": "#MIDI.addnote!-Tuple{MIDITrack,AbstractNote}",
    "page": "Home",
    "title": "MIDI.addnote!",
    "category": "method",
...
{
    "location": "#MIDI.addnotes!-Tuple{MIDITrack,Any}",
    "page": "Home",
    "title": "MIDI.addnotes!",
    "category": "method",
...
{
    "location": "#MIDI.addtrackname!-Tuple{MIDITrack,String}",
    "page": "Home",
...
{
    "location": "#MIDI.findtextevents-Tuple{Any,Any}",
    "page": "Home",
...
{
    "location": "#MIDI.name_to_pitch-Tuple{Any}",
    "page": "Home",
...
{
    "location": "#MIDI.pitch_to_name-Tuple{Any}",
    "page": "Home",
...
{
    "location": "#MIDI.readMIDIFile-Tuple{AbstractString}",
    "page": "Home",
...
{
    "location": "#MIDI.readvariablelength-Tuple{IO}",
    "page": "Home",
...
{
    "location": "#MIDI.textevent-Tuple{Any,Any}",
    "page": "Home",
...
{
    "location": "#MIDI.trackname-Tuple{MIDITrack}",
    "page": "Home",
...
{
    "location": "#MIDI.writeMIDIFile-Tuple{AbstractString,MIDIFile}",
    "page": "Home",
...
{
    "location": "#MIDI.writevariablelength-Tuple{IO,Int64}",
    "page": "Home",
...
{
    "location": "#MIDI.addevent_hint!-Tuple{MIDITrack,Integer,TrackEvent,Integer,Integer}",
    "page": "Home",
...
{
    "location": "#MIDI.get_abs_pos-Tuple{Any,MIDITrack}",
    "page": "Home",
...
{
    "location": "#MIDI.programchange-Tuple{MIDITrack,Integer,UInt8,UInt8}",
    "page": "Home",

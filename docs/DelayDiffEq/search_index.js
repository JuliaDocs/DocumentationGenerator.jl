...
{
    "location": "#DelayDiffEq.Discontinuity",
    "page": "Home",
...
{
    "location": "#DelayDiffEq.MethodOfSteps-Tuple{Any}",
    "page": "Home",
...
{
    "location": "#DiffEqBase.auto_dt_reset!-Tuple{DelayDiffEq.DDEIntegrator}",
    "page": "Home",
...
{
    "location": "#DiffEqBase.get_proposed_dt-Tuple{DelayDiffEq.DDEIntegrator}",
    "page": "Home",
...
{
    "location": "#DiffEqBase.initialize!-Tuple{DelayDiffEq.DDEIntegrator}",
    "page": "Home",
...
{
    "location": "#DiffEqBase.reeval_internals_due_to_modification!-Union{Tuple{DDEIntegrator}, Tuple{not_initialization}, Tuple{DDEIntegrator,Type{Val{not_initialization}}}} where not_initialization",
    "page": "Home",
...
{
    "location": "#DiffEqBase.set_proposed_dt!-Tuple{DelayDiffEq.DDEIntegrator,Any}",
    "page": "Home",
...
{
    "location": "#DiffEqBase.terminate!-Tuple{DelayDiffEq.DDEIntegrator}",
    "page": "Home",
...
{
    "location": "#DiffEqBase.u_modified!-Tuple{DelayDiffEq.DDEIntegrator,Bool}",
    "page": "Home",
...
{
    "location": "#DelayDiffEq.DiscontinuityCallback-Tuple{Any,Array{#s19066,1} where #s19066<:Discontinuity}",
    "page": "Home",
...
{
    "location": "#DelayDiffEq.HistoryFunction",
    "page": "Home",
...
{
    "location": "#DelayDiffEq.add_next_discontinuities!",
    "page": "Home",
...
{
    "location": "#DelayDiffEq.advance_ode_integrator!-Tuple{DelayDiffEq.DDEIntegrator}",
    "page": "Home",
...
{
    "location": "#DelayDiffEq.agrees-NTuple{4,Any}",
    "page": "Home",
...
{
    "location": "#DelayDiffEq.assign_expr-Union{Tuple{name}, Tuple{Val{name},Type,Type}} where name",
    "page": "Home",
...
{
    "location": "#DelayDiffEq.build_linked_cache-NTuple{9,Any}",
    "page": "Home",
...
{
    "location": "#DelayDiffEq.build_solution_array-Tuple{DelayDiffEq.DDEIntegrator}",
    "page": "Home",
...
{
    "location": "#DelayDiffEq.build_solution_interpolation-Tuple{DelayDiffEq.DDEIntegrator,RecursiveArrayTools.DiffEqArray}",
    "page": "Home",
...
{
    "location": "#DelayDiffEq.constant_extrapolant!-Tuple{Any,Any,DiffEqBase.DEIntegrator,Any,Any}",
    "page": "Home",
...
{
    "location": "#DelayDiffEq.constant_extrapolant-Tuple{Any,DiffEqBase.DEIntegrator,Any,Any}",
    "page": "Home",
    "title": "DelayDiffEq.constant_extrapolant",
    "category": "method",
...
{
    "location": "#DelayDiffEq.determine_discontinuity_existence-Tuple{Int64,Int64,Any,Any}",
    "page": "Home",
...
{
    "location": "#DelayDiffEq.find_discontinuity_time-Tuple{DelayDiffEq.DDEIntegrator,DelayDiffEq.DiscontinuityCallback,Int64,Int64,Any,Any}",
    "page": "Home",
...
{
    "location": "#DelayDiffEq.reduce_solution!-Tuple{DelayDiffEq.DDEIntegrator,Any}",
    "page": "Home",
...
{
    "location": "#DiffEqBase.apply_callback!-Tuple{DelayDiffEq.DDEIntegrator,DelayDiffEq.DiscontinuityCallback,Any,Any}",
    "page": "Home",
...
{
    "location": "#DiffEqBase.postamble!-Tuple{DelayDiffEq.DDEIntegrator}",
    "page": "Home",
...
{
    "location": "#OrdinaryDiffEq.handle_discontinuities!-Tuple{DelayDiffEq.DDEIntegrator}",
    "page": "Home",
...
{
    "location": "#OrdinaryDiffEq.perform_step!-Tuple{DelayDiffEq.DDEIntegrator}",
    "page": "Home",

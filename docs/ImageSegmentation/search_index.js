...
{
    "location": "#ImageSegmentation.ImageEdge",
    "page": "Home",
...
{
    "location": "#ImageSegmentation.SegmentedImage",
    "page": "Home",
...
{
    "location": "#ImageSegmentation.fast_scanning-Union{Tuple{N}, Tuple{CT}, Tuple{AbstractArray{CT,N},Union{Real, AbstractArray}}, Tuple{AbstractArray{CT,N},Union{Real, AbstractArray},Function}} where N where CT<:Union{Real, Colorant}",
    "page": "Home",
...
{
    "location": "#ImageSegmentation.felzenszwalb",
    "page": "Home",
...
{
    "location": "#ImageSegmentation.hmin_transform-Union{Tuple{N}, Tuple{T}, Tuple{Array{T,N},Real}} where N where T<:Union{Number, Color{T,1} where T}",
    "page": "Home",
...
{
    "location": "#ImageSegmentation.labels_map-Tuple{SegmentedImage}",
    "page": "Home",
...
{
    "location": "#ImageSegmentation.meanshift-Union{Tuple{CT}, Tuple{Array{CT,2},Real,Real}} where CT",
    "page": "Home",
...
{
    "location": "#ImageSegmentation.prune_segments-Tuple{SegmentedImage,Function,Function}",
    "page": "Home",
...
{
    "location": "#ImageSegmentation.region_adjacency_graph-Tuple{SegmentedImage,Function}",
    "page": "Home",
...
{
    "location": "#ImageSegmentation.region_splitting-Union{Tuple{T}, Tuple{N}, Tuple{AbstractArray{T,N},Function}} where T<:Union{Real, Colorant} where N",
    "page": "Home",
...
{
    "location": "#ImageSegmentation.region_tree-Union{Tuple{N}, Tuple{T}, Tuple{AbstractArray{T,N},Function}} where N where T<:Union{Real, Colorant}",
    "page": "Home",
...
{
    "location": "#ImageSegmentation.rem_segment!-Tuple{SegmentedImage,Int64,Function}",
    "page": "Home",
...
{
    "location": "#ImageSegmentation.rem_segment-Tuple{SegmentedImage,Vararg{Any,N} where N}",
    "page": "Home",
    "title": "ImageSegmentation.rem_segment",
    "category": "method",
...
{
    "location": "#ImageSegmentation.seeded_region_growing-Union{Tuple{N}, Tuple{CT}, Tuple{AbstractArray{CT,N},AbstractArray{Tuple{CartesianIndex{N},Int64},1}}, Tuple{AbstractArray{CT,N},AbstractArray{Tuple{CartesianIndex{N},Int64},1},Union{Array{Int64,1}, Tuple{Vararg{Int64,N}}}}, Tuple{AbstractArray{CT,N},AbstractArray{Tuple{CartesianIndex{N},Int64},1},Union{Array{Int64,1}, Tuple{Vararg{Int64,N}}},Function}} where N where CT<:Union{Real, Colorant}",
    "page": "Home",
...
{
    "location": "#ImageSegmentation.segment_labels-Tuple{SegmentedImage}",
    "page": "Home",
...
{
    "location": "#ImageSegmentation.segment_mean-Tuple{SegmentedImage,Int64}",
    "page": "Home",
...
{
    "location": "#ImageSegmentation.segment_pixel_count-Tuple{SegmentedImage,Int64}",
    "page": "Home",
...
{
    "location": "#ImageSegmentation.unseeded_region_growing-Union{Tuple{N}, Tuple{CT}, Tuple{AbstractArray{CT,N},Real}, Tuple{AbstractArray{CT,N},Real,Union{Array{Int64,1}, Tuple{Vararg{Int64,N}}}}, Tuple{AbstractArray{CT,N},Real,Union{Array{Int64,1}, Tuple{Vararg{Int64,N}}},Function}} where N where CT<:ColorTypes.Colorant",
    "page": "Home",
...
{
    "location": "#ImageSegmentation.watershed-Union{Tuple{N}, Tuple{S}, Tuple{T}, Tuple{AbstractArray{T,N},AbstractArray{S,N}}} where N where S<:Integer where T<:Union{Number, Color{T,1} where T}",
    "page": "Home",

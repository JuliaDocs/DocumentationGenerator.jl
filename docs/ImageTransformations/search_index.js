...
{
    "location": "#ImageTransformations.InvWarpedView",
    "page": "Home",
...
{
    "location": "#ImageTransformations.WarpedView",
    "page": "Home",
...
{
    "location": "#ImageTransformations.imresize-Union{Tuple{T}, Tuple{AbstractArray{T,0},Tuple{}}} where T",
    "page": "Home",
...
{
    "location": "#ImageTransformations.imrotate-Union{Tuple{T}, Tuple{AbstractArray{T,N} where N,Real,Vararg{Any,N} where N}} where T",
    "page": "Home",
...
{
    "location": "#ImageTransformations.invwarpedview-Tuple{AbstractArray,CoordinateTransformations.Transformation,Vararg{Any,N} where N}",
    "page": "Home",
    "title": "ImageTransformations.invwarpedview",
    "category": "method",
...
{
    "location": "#ImageTransformations.restrict-Tuple{AbstractArray,Tuple{}}",
    "page": "Home",
...
{
    "location": "#ImageTransformations.warp-Union{Tuple{T}, Tuple{AbstractExtrapolation{T,N,ITPT,IT} where IT where ITPT where N,Any}, Tuple{AbstractExtrapolation{T,N,ITPT,IT} where IT where ITPT where N,Any,Tuple}} where T",
    "page": "Home",
...
{
    "location": "#ImageTransformations.warpedview-Tuple{AbstractArray,CoordinateTransformations.Transformation,Vararg{Any,N} where N}",
    "page": "Home",
    "title": "ImageTransformations.warpedview",
    "category": "method",

...
{
    "location": "gp/#GaussianProcesses.predict_f-Tuple{GPBase,AbstractArray{T,2} where T}",
    "page": "Gaussian Processes",
...
{
    "location": "gp/#GaussianProcesses.GPE-Tuple{AbstractArray{T,2} where T,AbstractArray{T,1} where T,GaussianProcesses.Mean,Kernel,Float64,GaussianProcesses.KernelData,PDMats.AbstractPDMat}",
    "page": "Gaussian Processes",
...
{
    "location": "gp/#GaussianProcesses.GPE-Tuple{}",
    "page": "Gaussian Processes",
    "title": "GaussianProcesses.GPE",
    "category": "method",
...
{
    "location": "gp/#GaussianProcesses.GP",
    "page": "Gaussian Processes",
...
{
    "location": "gp/#GaussianProcesses.predict_y-Tuple{GPE,AbstractArray{T,2} where T}",
    "page": "Gaussian Processes",
...
{
    "location": "gp/#GaussianProcesses.update_target!-Tuple{GPE}",
    "page": "Gaussian Processes",
...
{
    "location": "gp/#GaussianProcesses.GPMC-Tuple{AbstractArray{T,2} where T,AbstractArray{#s2820,1} where #s2820<:Real,GaussianProcesses.Mean,Kernel,Likelihood}",
    "page": "Gaussian Processes",
...
{
    "location": "gp/#GaussianProcesses.GP-Tuple{Union{AbstractArray{Float64,1}, AbstractArray{Float64,2}},AbstractArray{#s2820,1} where #s2820<:Real,GaussianProcesses.Mean,Kernel,Likelihood}",
    "page": "Gaussian Processes",
    "title": "GaussianProcesses.GP",
    "category": "method",
...
{
    "location": "gp/#GaussianProcesses.predict_y-Tuple{GPMC,AbstractArray{T,2} where T}",
    "page": "Gaussian Processes",
    "title": "GaussianProcesses.predict_y",
    "category": "method",
...
{
    "location": "gp/#GaussianProcesses.update_target!-Tuple{GPMC}",
    "page": "Gaussian Processes",
    "title": "GaussianProcesses.update_target!",
    "category": "method",
...
{
    "location": "gp/#GaussianProcesses.mcmc-Tuple{GPBase}",
    "page": "Gaussian Processes",
...
{
    "location": "gp/#GaussianProcesses.make_posdef!-Tuple{AbstractArray{T,2} where T,AbstractArray{T,2} where T}",
    "page": "Gaussian Processes",
...
{
    "location": "gp/#GaussianProcesses.fit!-Union{Tuple{Y}, Tuple{X}, Tuple{GPE{X,Y,M,K,P,D} where D<:KernelData where P<:AbstractPDMat where K<:Kernel where M<:Mean,X,Y}} where Y where X",
    "page": "Gaussian Processes",
...
{
    "location": "gp/#GaussianProcesses.get_ααinvcKI!-Tuple{AbstractArray{T,2} where T,PDMats.AbstractPDMat,Array{T,1} where T}",
    "page": "Gaussian Processes",
...
{
    "location": "gp/#GaussianProcesses.initialise_target!-Tuple{GPE}",
    "page": "Gaussian Processes",
...
{
    "location": "gp/#GaussianProcesses.update_cK!-Tuple{GPE}",
    "page": "Gaussian Processes",
...
{
    "location": "gp/#GaussianProcesses.update_dmll!-Tuple{GPE,AbstractArray{T,2} where T}",
    "page": "Gaussian Processes",
...
{
    "location": "gp/#GaussianProcesses.update_mll_and_dmll!-Tuple{GPE,AbstractArray{T,2} where T}",
    "page": "Gaussian Processes",
...
{
    "location": "gp/#GaussianProcesses.update_target_and_dtarget!-Tuple{GPE,AbstractArray{T,2} where T,AbstractArray{T,2} where T}",
    "page": "Gaussian Processes",
...
{
    "location": "gp/#GaussianProcesses.initialise_ll!-Tuple{GPMC}",
    "page": "Gaussian Processes",
...
{
    "location": "gp/#GaussianProcesses.initialise_target!-Tuple{GPMC}",
    "page": "Gaussian Processes",
    "title": "GaussianProcesses.initialise_target!",
    "category": "method",
...
{
    "location": "gp/#GaussianProcesses.update_cK!-Tuple{GPMC}",
    "page": "Gaussian Processes",
    "title": "GaussianProcesses.update_cK!",
    "category": "method",
...
{
    "location": "gp/#GaussianProcesses.update_dll!-Tuple{GPMC,AbstractArray{T,2} where T,AbstractArray{T,2} where T}",
    "page": "Gaussian Processes",
...
{
    "location": "gp/#GaussianProcesses.update_target_and_dtarget!-Tuple{GPMC,AbstractArray{T,2} where T,AbstractArray{T,2} where T}",
    "page": "Gaussian Processes",
    "title": "GaussianProcesses.update_target_and_dtarget!",
    "category": "method",
...
{
    "location": "gp/#GaussianProcesses.composite_param_names-Tuple{Any,Any}",
    "page": "Gaussian Processes",
...
{
    "location": "gp/#GaussianProcesses.map_column_pairs!-Tuple{AbstractArray{T,2} where T,Any,AbstractArray{T,2} where T,AbstractArray{T,2} where T}",
    "page": "Gaussian Processes",
...
{
    "location": "gp/#GaussianProcesses.map_column_pairs-Tuple{Any,AbstractArray{T,2} where T,AbstractArray{T,2} where T}",
    "page": "Gaussian Processes",
    "title": "GaussianProcesses.map_column_pairs",
    "category": "method",
...
{
    "location": "gp/#Gaussian-Processes-1",
    "page": "Gaussian Processes",
    "title": "Gaussian Processes",
    "category": "section",
...
{
    "location": "kernels/#GaussianProcesses.Const",
    "page": "Kernels",
...
{
    "location": "kernels/#GaussianProcesses.Const-Union{Tuple{T}, Tuple{T}} where T",
    "page": "Kernels",
    "title": "GaussianProcesses.Const",
    "category": "method",
...
{
    "location": "kernels/#GaussianProcesses.Lin-Tuple{Real}",
    "page": "Kernels",
...
{
    "location": "kernels/#GaussianProcesses.LinArd",
    "page": "Kernels",
...
{
    "location": "kernels/#GaussianProcesses.LinArd-Union{Tuple{Array{T,1}}, Tuple{T}} where T",
    "page": "Kernels",
    "title": "GaussianProcesses.LinArd",
    "category": "method",
...
{
    "location": "kernels/#GaussianProcesses.LinIso",
    "page": "Kernels",
...
{
    "location": "kernels/#GaussianProcesses.LinIso-Union{Tuple{T}, Tuple{T}} where T",
    "page": "Kernels",
    "title": "GaussianProcesses.LinIso",
    "category": "method",
...
{
    "location": "kernels/#GaussianProcesses.Masked",
    "page": "Kernels",
...
{
    "location": "kernels/#GaussianProcesses.Matern-Tuple{Real,Real,Real}",
    "page": "Kernels",
...
{
    "location": "kernels/#GaussianProcesses.Mat12Ard",
    "page": "Kernels",
...
{
    "location": "kernels/#GaussianProcesses.Mat12Ard-Union{Tuple{T}, Tuple{Array{T,1},T}} where T",
    "page": "Kernels",
    "title": "GaussianProcesses.Mat12Ard",
    "category": "method",
...
{
    "location": "kernels/#GaussianProcesses.Mat12Iso",
    "page": "Kernels",
...
{
    "location": "kernels/#GaussianProcesses.Mat12Iso-Union{Tuple{T}, Tuple{T,T}} where T",
    "page": "Kernels",
    "title": "GaussianProcesses.Mat12Iso",
    "category": "method",
...
{
    "location": "kernels/#GaussianProcesses.Mat32Ard",
    "page": "Kernels",
...
{
    "location": "kernels/#GaussianProcesses.Mat32Ard-Union{Tuple{T}, Tuple{Array{T,1},T}} where T",
    "page": "Kernels",
    "title": "GaussianProcesses.Mat32Ard",
    "category": "method",
...
{
    "location": "kernels/#GaussianProcesses.Mat32Iso",
    "page": "Kernels",
...
{
    "location": "kernels/#GaussianProcesses.Mat32Iso-Union{Tuple{T}, Tuple{T,T}} where T",
    "page": "Kernels",
    "title": "GaussianProcesses.Mat32Iso",
    "category": "method",
...
{
    "location": "kernels/#GaussianProcesses.Mat52Ard",
    "page": "Kernels",
...
{
    "location": "kernels/#GaussianProcesses.Mat52Ard-Union{Tuple{T}, Tuple{Array{T,1},T}} where T",
    "page": "Kernels",
    "title": "GaussianProcesses.Mat52Ard",
    "category": "method",
...
{
    "location": "kernels/#GaussianProcesses.Mat52Iso",
    "page": "Kernels",
...
{
    "location": "kernels/#GaussianProcesses.Mat52Iso-Union{Tuple{T}, Tuple{T,T}} where T",
    "page": "Kernels",
    "title": "GaussianProcesses.Mat52Iso",
    "category": "method",
...
{
    "location": "kernels/#GaussianProcesses.Noise",
    "page": "Kernels",
...
{
    "location": "kernels/#GaussianProcesses.Noise-Union{Tuple{T}, Tuple{T}} where T",
    "page": "Kernels",
    "title": "GaussianProcesses.Noise",
    "category": "method",
...
{
    "location": "kernels/#GaussianProcesses.Periodic",
    "page": "Kernels",
...
{
    "location": "kernels/#GaussianProcesses.Periodic-Union{Tuple{T}, Tuple{T,T,T}} where T",
    "page": "Kernels",
    "title": "GaussianProcesses.Periodic",
    "category": "method",
...
{
    "location": "kernels/#GaussianProcesses.Poly",
    "page": "Kernels",
...
{
    "location": "kernels/#GaussianProcesses.Poly-Union{Tuple{T}, Tuple{T,T,Int64}} where T",
    "page": "Kernels",
    "title": "GaussianProcesses.Poly",
    "category": "method",
...
{
    "location": "kernels/#GaussianProcesses.RQ-Tuple{Real,Real,Real}",
    "page": "Kernels",
...
{
    "location": "kernels/#GaussianProcesses.RQArd",
    "page": "Kernels",
...
{
    "location": "kernels/#GaussianProcesses.RQArd-Union{Tuple{T}, Tuple{Array{T,1},T,T}} where T",
    "page": "Kernels",
    "title": "GaussianProcesses.RQArd",
    "category": "method",
...
{
    "location": "kernels/#GaussianProcesses.RQIso",
    "page": "Kernels",
...
{
    "location": "kernels/#GaussianProcesses.RQIso-Union{Tuple{T}, Tuple{T,T,T}} where T",
    "page": "Kernels",
    "title": "GaussianProcesses.RQIso",
    "category": "method",
...
{
    "location": "kernels/#GaussianProcesses.SE-Tuple{Real,Real}",
    "page": "Kernels",
...
{
    "location": "kernels/#GaussianProcesses.SEArd",
    "page": "Kernels",
...
{
    "location": "kernels/#GaussianProcesses.SEArd-Union{Tuple{T}, Tuple{Array{T,1},T}} where T",
    "page": "Kernels",
    "title": "GaussianProcesses.SEArd",
    "category": "method",
...
{
    "location": "kernels/#GaussianProcesses.SEIso",
    "page": "Kernels",
...
{
    "location": "kernels/#GaussianProcesses.SEIso-Union{Tuple{T}, Tuple{T,T}} where T",
    "page": "Kernels",
    "title": "GaussianProcesses.SEIso",
    "category": "method",
...
{
    "location": "kernels/#GaussianProcesses.EmptyData",
    "page": "Kernels",
...
{
    "location": "kernels/#GaussianProcesses.KernelData",
    "page": "Kernels",
...
{
    "location": "kernels/#GaussianProcesses.cov!",
    "page": "Kernels",
...
{
    "location": "kernels/#Statistics.cov",
    "page": "Kernels",
...
{
    "location": "kernels/#Statistics.cov-Tuple{Kernel,AbstractArray{T,2} where T,GaussianProcesses.EmptyData}",
    "page": "Kernels",
    "title": "Statistics.cov",
    "category": "method",
...
{
    "location": "mean/#GaussianProcesses.MeanConst",
    "page": "Means",
...
{
    "location": "mean/#GaussianProcesses.MeanLin",
    "page": "Means",
...
{
    "location": "mean/#GaussianProcesses.MeanPoly",
    "page": "Means",
...
{
    "location": "mean/#GaussianProcesses.MeanZero",
    "page": "Means",
...
{
    "location": "lik/#GaussianProcesses.BernLik",
    "page": "Likelihoods",
...
{
    "location": "lik/#GaussianProcesses.BinLik",
    "page": "Likelihoods",
...
{
    "location": "lik/#GaussianProcesses.ExpLik",
    "page": "Likelihoods",
...
{
    "location": "lik/#GaussianProcesses.GaussLik",
    "page": "Likelihoods",
...
{
    "location": "lik/#GaussianProcesses.PoisLik",
    "page": "Likelihoods",
...
{
    "location": "lik/#GaussianProcesses.StuTLik",
    "page": "Likelihoods",
...
{
    "location": "lik/#GaussianProcesses.predict_obs-Tuple{Likelihood,AbstractArray{T,1} where T,AbstractArray{T,1} where T}",
    "page": "Likelihoods",

...
{
    "location": "#HTTP.request-Tuple{String,HTTP.URIs.URI,Array{Pair{SubString{String},SubString{String}},1},Any}",
    "page": "Home",
    "title": "HTTP.request",
    "category": "method",
...
{
    "location": "#HTTP.ExceptionRequest.StatusError",
    "page": "Home",
...
{
    "location": "#HTTP.Parsers.ParseError",
    "page": "Home",
...
{
    "location": "#HTTP.IOExtras.IOError",
    "page": "Home",
...
{
    "location": "#HTTP.Handlers.Handler",
    "page": "Home",
...
{
    "location": "#HTTP.Handlers.HandlerFunction",
    "page": "Home",
...
{
    "location": "#HTTP.Handlers.register!",
    "page": "Home",
...
{
    "location": "#HTTP.URIs.unescapeuri",
    "page": "Home",
...
{
    "location": "#Base.isvalid-Tuple{HTTP.URIs.URI}",
    "page": "Home",
    "title": "Base.isvalid",
    "category": "method",
...
{
    "location": "#HTTP.Strings.escapehtml",
    "page": "Home",
...
{
    "location": "#HTTP.jl-Internal-Architecture-1",
    "page": "Home",
...
{
    "location": "#HTTP.RedirectRequest.RedirectLayer",
    "page": "Home",
...
{
    "location": "#HTTP.BasicAuthRequest.BasicAuthLayer",
    "page": "Home",
...
{
    "location": "#HTTP.CookieRequest.CookieLayer",
    "page": "Home",
...
{
    "location": "#HTTP.CanonicalizeRequest.CanonicalizeLayer",
    "page": "Home",
...
{
    "location": "#HTTP.MessageRequest.MessageLayer",
    "page": "Home",
...
{
    "location": "#HTTP.AWS4AuthRequest.AWS4AuthLayer",
    "page": "Home",
...
{
    "location": "#HTTP.RetryRequest.RetryLayer",
    "page": "Home",
...
{
    "location": "#HTTP.ExceptionRequest.ExceptionLayer",
    "page": "Home",
...
{
    "location": "#HTTP.ConnectionRequest.ConnectionPoolLayer",
    "page": "Home",
...
{
    "location": "#HTTP.TimeoutRequest.TimeoutLayer",
    "page": "Home",
...
{
    "location": "#HTTP.StreamRequest.StreamLayer",
    "page": "Home",
...
{
    "location": "#Request-Execution-Layers-1",
    "page": "Home",
...
{
    "location": "#HTTP.Parsers.find_end_of_header",
    "page": "Home",
...
{
    "location": "#HTTP.Parsers.find_end_of_line",
    "page": "Home",
...
{
    "location": "#HTTP.Parsers.find_end_of_trailer",
    "page": "Home",
...
{
    "location": "#HTTP.Parsers.parse_status_line!",
    "page": "Home",
...
{
    "location": "#HTTP.Parsers.parse_request_line!",
    "page": "Home",
...
{
    "location": "#HTTP.Parsers.parse_header_field",
    "page": "Home",
...
{
    "location": "#HTTP.Parsers.parse_chunk_size",
    "page": "Home",
...
{
    "location": "#HTTP.Messages.Request",
    "page": "Home",
...
{
    "location": "#HTTP.Messages.Response",
    "page": "Home",
...
{
    "location": "#HTTP.Messages.iserror",
    "page": "Home",
...
{
    "location": "#HTTP.Messages.isredirect",
    "page": "Home",
...
{
    "location": "#HTTP.Messages.ischunked",
    "page": "Home",
...
{
    "location": "#HTTP.Messages.isidempotent",
    "page": "Home",
...
{
    "location": "#HTTP.Messages.hasheader",
    "page": "Home",
...
{
    "location": "#HTTP.Messages.setheader",
    "page": "Home",
...
{
    "location": "#HTTP.Messages.defaultheader",
    "page": "Home",
...
{
    "location": "#HTTP.Messages.appendheader",
    "page": "Home",
...
{
    "location": "#HTTP.Messages.readheaders",
    "page": "Home",
...
{
    "location": "#HTTP.MessageRequest.setuseragent!",
    "page": "Home",
...
{
    "location": "#HTTP.Messages.readchunksize",
    "page": "Home",
...
{
    "location": "#HTTP.Messages.headerscomplete-Tuple{HTTP.Messages.Response}",
    "page": "Home",
...
{
    "location": "#HTTP.Messages.writestartline",
    "page": "Home",
...
{
    "location": "#HTTP.Messages.writeheaders",
    "page": "Home",
...
{
    "location": "#Base.write-Tuple{IO,HTTP.Messages.Message}",
    "page": "Home",
    "title": "Base.write",
    "category": "method",
...
{
    "location": "#HTTP.Streams.closebody",
    "page": "Home",
...
{
    "location": "#HTTP.Streams.isaborted",
    "page": "Home",
...
{
    "location": "#HTTP.ConnectionPool.Connection",
    "page": "Home",
...
{
    "location": "#HTTP.ConnectionPool.Transaction",
    "page": "Home",
...
{
    "location": "#HTTP.ConnectionPool.pool",
    "page": "Home",
...
{
    "location": "#HTTP.ConnectionPool.getconnection",
    "page": "Home",
...
{
    "location": "#HTTP.IOExtras.unread!-Tuple{HTTP.ConnectionPool.Transaction,SubArray{UInt8,1,Array{UInt8,1},Tuple{UnitRange{Int64}},true}}",
    "page": "Home",
...
{
    "location": "#HTTP.IOExtras.startwrite-Tuple{HTTP.ConnectionPool.Transaction}",
    "page": "Home",
...
{
    "location": "#HTTP.IOExtras.closewrite-Tuple{HTTP.ConnectionPool.Transaction}",
    "page": "Home",
...
{
    "location": "#HTTP.IOExtras.startread-Tuple{HTTP.ConnectionPool.Transaction}",
    "page": "Home",
...
{
    "location": "#HTTP.IOExtras.closeread-Tuple{HTTP.ConnectionPool.Transaction}",
    "page": "Home",
...
{
    "location": "#Connection-Pooling-Interface-1",
    "page": "Home",

...
{
    "location": "options/#atol::Float64-[1e-6]-1",
    "page": "Options",
...
{
    "location": "options/#branch_strategy::Symbol-[:StrongPseudoCost]-1",
    "page": "Options",
...
{
    "location": "options/#traverse_strategy::Symbol-[:BFS]-1",
    "page": "Options",
...
{
    "location": "options/#Objective-Cuts-1",
    "page": "Options",
...
{
    "location": "options/#incumbent_constr::Bool-[false]-1",
    "page": "Options",
...
{
    "location": "options/#obj_epsilon::0-[Float64]-1",
    "page": "Options",
...
{
    "location": "options/#Options-for-strong-branching-1",
    "page": "Options",
...
{
    "location": "options/#strong*branching*perc::Float64-[100]-1",
    "page": "Options",
...
{
    "location": "options/#strong*branching*nsteps::Int64-[1]-1",
    "page": "Options",
...
{
    "location": "options/#strong*branching*approx*time*limit::Float64-[100]s-1",
    "page": "Options",
...
{
    "location": "options/#strong_restart::Bool-[true]-1",
    "page": "Options",
...
{
    "location": "options/#Options-for-reliablity-branching-1",
    "page": "Options",
...
{
    "location": "options/#reliablility*branching*perc::Float64-[25]-1",
    "page": "Options",
...
{
    "location": "options/#reliablility*branching*threshold::Int64-[5]-1",
    "page": "Options",
...
{
    "location": "options/#strong_restart::Bool-[true]-2",
    "page": "Options",
    "title": "strong_restart::Bool [true]",
    "category": "section",
...
{
    "location": "options/#Options-gain-computation-1",
    "page": "Options",
...
{
    "location": "options/#gain_mu::Float64-[0.167]-1",
    "page": "Options",
...
{
    "location": "options/#processors::Int64-[1]-1",
    "page": "Options",
...
{
    "location": "options/#Feasibility-Pump-1",
    "page": "Options",
...
{
    "location": "options/#feasibility_pump::Bool-[Auto]-1",
    "page": "Options",
...
{
    "location": "options/#mip_solver::MathProgBase.AbstractMathProgSolver-[nothing]-1",
    "page": "Options",
...
{
    "location": "options/#feasibility*pump*time_limit::Int64-[60]s-1",
    "page": "Options",
...
{
    "location": "options/#feasibility*pump*tolerance_counter::Int64-[5]-1",
    "page": "Options",
...
{
    "location": "options/#tabu*list*length::Int64-[30]-1",
    "page": "Options",
...
{
    "location": "options/#num*resolve*nlp*feasibility*pump::Int64-[1]-1",
    "page": "Options",
...
{
    "location": "options/#User-Limits-1",
    "page": "Options",
    "title": "User Limits",
    "category": "section",
...
{
    "location": "options/#time_limit::Float64-[Inf]-1",
    "page": "Options",
...
{
    "location": "options/#mip_gap::Float64-[0.0001]-1",
    "page": "Options",
...
{
    "location": "options/#best*obj*stop::Float-[NaN]-1",
    "page": "Options",
...
{
    "location": "options/#solution_limit::Int-[0]-1",
    "page": "Options",
...
{
    "location": "options/#num*resolve*root_relaxation::Int-[3]-1",
    "page": "Options",
...
{
    "location": "options/#log_levels::Vector{Symbol}-[[:Table,:Info,:Options]]-1",
    "page": "Options",

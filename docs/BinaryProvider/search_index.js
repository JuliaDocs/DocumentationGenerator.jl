...
{
    "location": "#BinaryProvider.ExecutableProduct",
    "page": "Home",
...
{
    "location": "#BinaryProvider.FileProduct",
    "page": "Home",
...
{
    "location": "#BinaryProvider.LibraryProduct",
    "page": "Home",
...
{
    "location": "#BinaryProvider.OutputCollector",
    "page": "Home",
...
{
    "location": "#BinaryProvider.OutputCollector-Tuple{Base.AbstractCmd}",
    "page": "Home",
    "title": "BinaryProvider.OutputCollector",
    "category": "method",
...
{
    "location": "#BinaryProvider.Product",
    "page": "Home",
...
{
    "location": "#Base.merge-Tuple{OutputCollector}",
    "page": "Home",
    "title": "Base.merge",
    "category": "method",
...
{
    "location": "#BinaryProvider.arch-Tuple{Platform}",
    "page": "Home",
...
{
    "location": "#BinaryProvider.bindir-Tuple{Prefix}",
    "page": "Home",
...
{
    "location": "#BinaryProvider.call_abi-Tuple{Platform}",
    "page": "Home",
...
{
    "location": "#BinaryProvider.choose_download",
    "page": "Home",
...
{
    "location": "#BinaryProvider.collect_stderr-Tuple{OutputCollector}",
    "page": "Home",
...
{
    "location": "#BinaryProvider.collect_stdout-Tuple{OutputCollector}",
    "page": "Home",
...
{
    "location": "#BinaryProvider.download_verify-Tuple{AbstractString,AbstractString,AbstractString}",
    "page": "Home",
...
{
    "location": "#BinaryProvider.download_verify_unpack-Tuple{AbstractString,AbstractString,AbstractString}",
    "page": "Home",
...
{
    "location": "#BinaryProvider.extract_name_version_platform_key-Tuple{AbstractString}",
    "page": "Home",
...
{
    "location": "#BinaryProvider.extract_platform_key-Tuple{AbstractString}",
    "page": "Home",
...
{
    "location": "#BinaryProvider.gen_download_cmd",
    "page": "Home",
...
{
    "location": "#BinaryProvider.gen_list_tarball_cmd",
    "page": "Home",
...
{
    "location": "#BinaryProvider.gen_package_cmd",
    "page": "Home",
...
{
    "location": "#BinaryProvider.gen_sh_cmd",
    "page": "Home",
...
{
    "location": "#BinaryProvider.gen_unpack_cmd",
    "page": "Home",
...
{
    "location": "#BinaryProvider.includedir-Tuple{Prefix}",
    "page": "Home",
...
{
    "location": "#BinaryProvider.install-Tuple{AbstractString,AbstractString}",
    "page": "Home",
...
{
    "location": "#BinaryProvider.isinstalled-Tuple{AbstractString,AbstractString}",
    "page": "Home",
...
{
    "location": "#BinaryProvider.libc-Tuple{Platform}",
    "page": "Home",
...
{
    "location": "#BinaryProvider.libdir",
    "page": "Home",
...
{
    "location": "#BinaryProvider.list_tarball_files-Tuple{AbstractString}",
    "page": "Home",
...
{
    "location": "#BinaryProvider.locate-Tuple{ExecutableProduct}",
    "page": "Home",
...
{
    "location": "#BinaryProvider.locate-Tuple{FileProduct}",
    "page": "Home",
    "title": "BinaryProvider.locate",
    "category": "method",
...
{
    "location": "#BinaryProvider.locate-Tuple{LibraryProduct}",
    "page": "Home",
    "title": "BinaryProvider.locate",
    "category": "method",
...
{
    "location": "#BinaryProvider.logdir-Tuple{Prefix}",
    "page": "Home",
...
{
    "location": "#BinaryProvider.manifest_for_file-Tuple{AbstractString}",
    "page": "Home",
...
{
    "location": "#BinaryProvider.manifest_from_url-Tuple{AbstractString}",
    "page": "Home",
...
{
    "location": "#BinaryProvider.package-Tuple{AbstractString,AbstractString}",
    "page": "Home",
...
{
    "location": "#BinaryProvider.package-Tuple{Prefix,AbstractString,VersionNumber}",
    "page": "Home",
    "title": "BinaryProvider.package",
    "category": "method",
...
{
    "location": "#BinaryProvider.parse_7z_list-Tuple{AbstractString}",
    "page": "Home",
...
{
    "location": "#BinaryProvider.parse_tar_list-Tuple{AbstractString}",
    "page": "Home",
...
{
    "location": "#BinaryProvider.parse_tarball_listing",
    "page": "Home",
...
{
    "location": "#BinaryProvider.platform_dlext-Tuple{Linux}",
    "page": "Home",
...
{
    "location": "#BinaryProvider.platform_key_abi-Tuple{AbstractString}",
    "page": "Home",
...
{
    "location": "#BinaryProvider.satisfied-Tuple{Product}",
    "page": "Home",
...
{
    "location": "#BinaryProvider.tail-Tuple{OutputCollector}",
    "page": "Home",
...
{
    "location": "#BinaryProvider.tee-Tuple{OutputCollector}",
    "page": "Home",
...
{
    "location": "#BinaryProvider.temp_prefix-Tuple{Function}",
    "page": "Home",
...
{
    "location": "#BinaryProvider.triplet-Tuple{Platform}",
    "page": "Home",
...
{
    "location": "#BinaryProvider.uninstall-Tuple{AbstractString}",
    "page": "Home",
...
{
    "location": "#BinaryProvider.unpack-Tuple{AbstractString,AbstractString}",
    "page": "Home",
...
{
    "location": "#BinaryProvider.valid_dl_path-Tuple{AbstractString,Platform}",
    "page": "Home",
...
{
    "location": "#BinaryProvider.variable_name-Tuple{Product}",
    "page": "Home",
...
{
    "location": "#BinaryProvider.verify-Tuple{AbstractString,AbstractString}",
    "page": "Home",
...
{
    "location": "#BinaryProvider.wordsize-Tuple{Platform}",
    "page": "Home",
...
{
    "location": "#BinaryProvider.write_deps_file-Union{Tuple{P}, Tuple{AbstractString,Array{P,1}}} where P<:Product",
    "page": "Home",
...
{
    "location": "#BinaryProvider.LineStream-Tuple{Pipe,Condition}",
    "page": "Home",
...
{
    "location": "#Base.wait-Tuple{OutputCollector}",
    "page": "Home",
    "title": "Base.wait",
    "category": "method",
...
{
    "location": "#Base.withenv-Tuple{Function,Array{Prefix,1}}",
    "page": "Home",
    "title": "Base.withenv",
    "category": "method",
...
{
    "location": "#BinaryProvider.alive-Tuple{BinaryProvider.LineStream}",
    "page": "Home",
...
{
    "location": "#BinaryProvider.compiler_abi-Tuple{Platform}",
    "page": "Home",
...
{
    "location": "#BinaryProvider.detect_cxx11_string_abi-Tuple{}",
    "page": "Home",
...
{
    "location": "#BinaryProvider.detect_libgfortran_abi",
    "page": "Home",
...
{
    "location": "#BinaryProvider.detect_libgfortran_abi-Tuple{}",
    "page": "Home",
    "title": "BinaryProvider.detect_libgfortran_abi",
    "category": "method",
...
{
    "location": "#BinaryProvider.detect_libstdcxx_abi-Tuple{}",
    "page": "Home",
...
{
    "location": "#BinaryProvider.download-Tuple{AbstractString,AbstractString}",
    "page": "Home",
...
{
    "location": "#BinaryProvider.info_onchange-Tuple{Any,Any,Any}",
    "page": "Home",
...
{
    "location": "#BinaryProvider.parse_dl_name_version-Tuple{AbstractString,Platform}",
    "page": "Home",
...
{
    "location": "#BinaryProvider.platform_name-Tuple{Linux}",
    "page": "Home",
...
{
    "location": "#BinaryProvider.probe_cmd-Tuple{Cmd}",
    "page": "Home",
...
{
    "location": "#BinaryProvider.probe_platform_engines!-Tuple{}",
    "page": "Home",
...
{
    "location": "#BinaryProvider.probe_symlink_creation-Tuple{AbstractString}",
    "page": "Home",
...
{
    "location": "#BinaryProvider.readuntil_many-Tuple{IO,Any}",
    "page": "Home",

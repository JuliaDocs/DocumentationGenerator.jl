...
{
    "location": "#DelayEmbeddings.jl-1",
    "page": "Readme",
    "title": "DelayEmbeddings.jl",
    "category": "section",
    "text": "(Image: DynamicalSystems.jl logo: The Double Pendulum)Documentation Travis AppVeyor Gitter\n(Image: ) (Image: Build Status) (Image: Build status) (Image: Gitter)This repo is a minimal package used throughout JuliaDynamics. The features are:Defines the Dataset structure, which is a wrapper of Vector{SVector}, used in DynamicalSystems.jl.\nImplements methods for delay coordinates embedding (Takens\' theorem) with high performance and many features.\nAlgorithms for estimating optimal delay embedding parameters, the delay time and the number of temporal neighbors (generalization of the \"embedding dimension\").\nProvides a unified neighborhood function that works across different kinds of nearest neighbor searching packages."
},

{
    "location": "autodocs/#DelayEmbeddings.AbstractEmbedding",
    "page": "Docstrings",
...
{
    "location": "autodocs/#DelayEmbeddings.AbstractNeighborhood",
    "page": "Docstrings",
...
{
    "location": "autodocs/#DelayEmbeddings.Dataset",
    "page": "Docstrings",
...
{
    "location": "autodocs/#DelayEmbeddings.DelayEmbedding",
    "page": "Docstrings",
...
{
    "location": "autodocs/#DelayEmbeddings.MTDelayEmbedding",
    "page": "Docstrings",
...
{
    "location": "autodocs/#DelayEmbeddings.columns",
    "page": "Docstrings",
...
{
    "location": "autodocs/#DelayEmbeddings.embed-Tuple{Any,Any,Any}",
    "page": "Docstrings",
...
{
    "location": "autodocs/#DelayEmbeddings.estimate_delay",
    "page": "Docstrings",
...
{
    "location": "autodocs/#DelayEmbeddings.estimate_dimension",
    "page": "Docstrings",
...
{
    "location": "autodocs/#DelayEmbeddings.exponential_decay_fit",
    "page": "Docstrings",
...
{
    "location": "autodocs/#DelayEmbeddings.maxima-Union{Tuple{AbstractDataset{D,T}}, Tuple{T}, Tuple{D}} where T<:Real where D",
    "page": "Docstrings",
...
{
    "location": "autodocs/#DelayEmbeddings.min_pairwise_distance-Tuple{AbstractArray{T,2} where T}",
    "page": "Docstrings",
...
{
    "location": "autodocs/#DelayEmbeddings.minima-Union{Tuple{AbstractDataset{D,T}}, Tuple{T}, Tuple{D}} where T<:Real where D",
    "page": "Docstrings",
...
{
    "location": "autodocs/#DelayEmbeddings.minmaxima-Union{Tuple{AbstractDataset{D,T}}, Tuple{T}, Tuple{D}} where T<:Real where D",
    "page": "Docstrings",
...
{
    "location": "autodocs/#DelayEmbeddings.mutualinformation-Union{Tuple{T}, Tuple{AbstractArray{T,1},AbstractArray{Int64,1}}} where T",
    "page": "Docstrings",
...
{
    "location": "autodocs/#DelayEmbeddings.neighborhood",
    "page": "Docstrings",
...
{
    "location": "autodocs/#DelayEmbeddings.orthonormal",
    "page": "Docstrings",
...
{
    "location": "autodocs/#DelayEmbeddings.reconstruct-Union{Tuple{T}, Tuple{AbstractArray{T,1},Any,Any}} where T",
    "page": "Docstrings",
...
{
    "location": "autodocs/#DelayEmbeddings.stochastic_indicator-Union{Tuple{T}, Tuple{AbstractArray{T,1},Any}, Tuple{AbstractArray{T,1},Any,Any}} where T",
    "page": "Docstrings",
...
{
    "location": "autodocs/#DelayEmbeddings._bisect-Union{Tuple{AbstractArray{T,1}}, Tuple{T}} where T",
    "page": "Docstrings",
...
{
    "location": "autodocs/#DelayEmbeddings._equalbins-Union{Tuple{AbstractArray{T,1}}, Tuple{T}} where T",
    "page": "Docstrings",
...
{
    "location": "autodocs/#DelayEmbeddings._frequencies!-Union{Tuple{T}, Tuple{AbstractArray{T,1},AbstractArray{T,1} where T,AbstractArray{T,1} where T}} where T",
    "page": "Docstrings",
...
{
    "location": "autodocs/#DelayEmbeddings._mutualinfo!-Tuple{AbstractArray{T,1} where T,AbstractArray{T,1} where T,AbstractArray{#s830,1} where #s830<:Integer,AbstractArray{T,1} where T}",
    "page": "Docstrings",
...
{
    "location": "autodocs/#DelayEmbeddings._uniformtest-Tuple{Any}",
    "page": "Docstrings",
...
{
    "location": "autodocs/#DelayEmbeddings.afnn-Union{Tuple{T}, Tuple{AbstractArray{T,1},Int64}, Tuple{AbstractArray{T,1},Int64,Any}, Tuple{AbstractArray{T,1},Int64,Any,Any}} where T",
    "page": "Docstrings",
...
{
    "location": "autodocs/#DelayEmbeddings.f1nn",
    "page": "Docstrings",
...
{
    "location": "autodocs/#DelayEmbeddings.fnn",
    "page": "Docstrings",
...
{
    "location": "autodocs/#DelayEmbeddings.localextrema-Tuple{Any}",
    "page": "Docstrings",
...
{
    "location": "autodocs/#DelayEmbeddings.svd-Tuple{AbstractDataset}",
    "page": "Docstrings",

...
{
    "location": "#ChaosTools.broomhead_king-Tuple{AbstractArray,Int64}",
    "page": "Home",
...
{
    "location": "#ChaosTools.capacity_dim-Tuple",
    "page": "Home",
...
{
    "location": "#ChaosTools.estimate_boxsizes-Union{Tuple{AbstractDataset{D,T}}, Tuple{T}, Tuple{D}} where T<:Number where D",
    "page": "Home",
...
{
    "location": "#ChaosTools.gali-Tuple{DynamicalSystem,Real,Int64}",
    "page": "Home",
...
{
    "location": "#ChaosTools.genentropy-Tuple{Real,Real,AbstractDataset}",
    "page": "Home",
...
{
    "location": "#ChaosTools.generalized_dim",
    "page": "Home",
...
{
    "location": "#ChaosTools.information_dim-Tuple",
    "page": "Home",
...
{
    "location": "#ChaosTools.kaplanyorke_dim-Tuple{AbstractArray{T,1} where T}",
    "page": "Home",
...
{
    "location": "#ChaosTools.lambdamatrix-Tuple{Real,AbstractArray{#s19430,1} where #s19430<:Integer,AbstractArray{#s19429,1} where #s19429<:Real}",
    "page": "Home",
...
{
    "location": "#ChaosTools.lambdaperms-Tuple{Integer}",
    "page": "Home",
...
{
    "location": "#ChaosTools.linear_region-Tuple{AbstractArray{T,1} where T,AbstractArray{T,1} where T}",
    "page": "Home",
...
{
    "location": "#ChaosTools.linear_regions-Tuple{AbstractArray{T,1} where T,AbstractArray{T,1} where T}",
    "page": "Home",
...
{
    "location": "#ChaosTools.lyapunov-Tuple{DynamicalSystem,Any}",
    "page": "Home",
...
{
    "location": "#ChaosTools.non0hist-Union{Tuple{T}, Tuple{D}, Tuple{Real,AbstractDataset{D,T}}} where T<:Real where D",
    "page": "Home",
...
{
    "location": "#ChaosTools.numericallyapunov-Union{Tuple{T}, Tuple{D}, Tuple{AbstractDataset{D,T},Any}} where T where D",
    "page": "Home",
...
{
    "location": "#ChaosTools.orbitdiagram-Union{Tuple{D}, Tuple{S}, Tuple{IIP}, Tuple{DiscreteDynamicalSystem{IIP,S,D,F,P,JAC,JM,IAD} where IAD where JM where JAC where P where F,Any,Any,Any}} where D where S where IIP",
    "page": "Home",
...
{
    "location": "#ChaosTools.periodicorbits-Union{Tuple{S}, Tuple{DiscreteDynamicalSystem{false,S,D,F,P,JAC,JM,IAD} where IAD where JM where JAC where P where F where D,Int64,Any,Any,Any,Any}} where S",
    "page": "Home",
...
{
    "location": "#ChaosTools.permentropy-Union{Tuple{T}, Tuple{AbstractArray{T,1},Integer}, Tuple{AbstractArray{T,1},Integer,Integer}} where T",
    "page": "Home",
...
{
    "location": "#ChaosTools.poincaresos-Union{Tuple{D}, Tuple{S}, Tuple{IIP}, Tuple{ContinuousDynamicalSystem{IIP,S,D,F,P,JAC,JM,IAD} where IAD where JM where JAC where P where F,Any}, Tuple{ContinuousDynamicalSystem{IIP,S,D,F,P,JAC,JM,IAD} where IAD where JM where JAC where P where F,Any,Any}} where D where S where IIP",
    "page": "Home",
...
{
    "location": "#ChaosTools.produce_orbitdiagram-Union{Tuple{D}, Tuple{S}, Tuple{IIP}, Tuple{ContinuousDynamicalSystem{IIP,S,D,F,P,JAC,JM,IAD} where IAD where JM where JAC where P where F,Any,Any,Any,Any}} where D where S where IIP",
    "page": "Home",
...
{
    "location": "#ChaosTools.max_linear_region-Tuple{Array{Int64,1},Array{Float64,1}}",
    "page": "Home",

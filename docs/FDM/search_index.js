...
{
    "location": "#FDM.jl:-Finite-Difference-Methods-1",
    "page": "Home",
...
{
    "location": "pages/api/#FDM.FDMReport",
    "page": "API",
    "title": "FDM.FDMReport",
    "category": "type",
...
{
    "location": "pages/api/#FDM.assert_approx_equal-NTuple{5,Any}",
    "page": "API",
...
{
    "location": "pages/api/#FDM.backward_fdm-Tuple{Int64,Vararg{Any,N} where N}",
    "page": "API",
...
{
    "location": "pages/api/#FDM.central_fdm-Tuple{Int64,Vararg{Any,N} where N}",
    "page": "API",
...
{
    "location": "pages/api/#FDM.fdm-Union{Tuple{T}, Tuple{AbstractArray{T,1},Int64,Val{false}}} where T<:Real",
    "page": "API",
    "title": "FDM.fdm",
    "category": "method",
...
{
    "location": "pages/api/#FDM.forward_fdm-Tuple{Int64,Vararg{Any,N} where N}",
    "page": "API",
